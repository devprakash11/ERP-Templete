...
const Sidebar = ({ isOpen, onToggle }) => (
  <>
    {isOpen && (
      <button className="fixed inset-0 z-40 bg-black/40 md:hidden" onClick={onToggle} aria-label="Close navigation overlay" />
    )}
...
const PageHeader = ({ title, subtitle }) => (
  <div className="mb-6"><h1 className="text-2xl font-bold tracking-tight text-text-primary">{title}</h1>{subtitle && <p className="mt-1 text-sm text-text-secondary">{subtitle}</p>}</div>
)
